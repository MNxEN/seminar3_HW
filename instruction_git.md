...
Чтобы загрузить данные из локального репозитория в удаленный нужно ввсети команду:
	...
	git push
если в удаленном репозитории были сделаны и сохранены изменения после последней синхронизации репозиториев, то перед командой *git push* необходимо выполнить команду *git pull*
...
### Ветвление репозитория (создание вилки)

Чтобы создать вилку (fork) нужного удаленного репозитория на сайте GitHub, необходимо пройти по ссылке к этому удаленному репозиторию и нажать кнопку

    Fork 
Далее в следующем окне нажать кнопку 

    Create fork
Затем открыть страницу своего аккаунта на сайте GitHub и открыть ответвленный репозиторий. Нажать кнопку

    Code
и скопировать ссылку на репотозиторий

### Клонирование удаленного репозитория

Для создании локальной копии удаленного репозитория сначала нужно создать новый каталог в нужном месте на ПК, затем в проводнике приложения VSC открыть это каталог. Далее в терминале ввести комманду:

    git clone <путь к удаленному репозиторию>
В нашем каталоге появится копия удаленного репозитория, теперь для перехода в каталог репозитория необходимо ввсети команду:

    cd <name_katalog>
 После этого у нас будет открыт уже инициализированный репозиторий (копия удаленного репозитория)